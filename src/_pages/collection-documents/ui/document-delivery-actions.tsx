  ...
  return (
    <div className="mt-4 rounded-small border border-border bg-background p-3">
      ...
      <div className="mt-3 flex flex-wrap gap-2">
        ...
        <button type="button" onClick={() => void sendEmail()} disabled={busy || email.length === 0 || !shareUrl} className="rounded-md border border-border px-3 py-2 text-sm font-semibold disabled:opacity-60">Enviar e-mail</button>
      </div>
