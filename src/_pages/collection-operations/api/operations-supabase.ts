...
import type {
  ...
  TechnicalBudgetRpcItem,
  WorkshopCheckInRpcItem,
} from "../model/workshop-rpc-items";
...
export type OperationsFunctions = {
  ...
  workshop_check_in: { Args: { p_collection_id: string; p_expected_version: number; p_administrator_name: string; p_administrator_tax_id: string; p_items: readonly WorkshopCheckInRpcItem[]; p_signature_intent_id: string; p_idempotency_key: string; p_request_hash: string }; Returns: Json };
  create_technical_budget: { Args: { p_collection_id: string; p_expected_version: number; p_items: readonly TechnicalBudgetRpcItem[]; p_general_notes: string | null; p_idempotency_key: string; p_request_hash: string }; Returns: Json };
  ...
  update_service_progress: { Args: { p_collection_id: string; p_expected_version: number; p_items: readonly ServiceProgressRpcItem[]; p_idempotency_key: string; p_request_hash: string }; Returns: Json };
