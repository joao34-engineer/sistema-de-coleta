...
const failureMessages: Readonly<Record<string, string>> = {
  ...
  delivery_not_invoiced: "A coleta precisa estar pronta, faturada ou em entrega parcial para entregar ao cliente.",
  collection_not_invoiced: "A coleta precisa estar pronta, faturada ou em entrega parcial para entregar ao cliente.",
