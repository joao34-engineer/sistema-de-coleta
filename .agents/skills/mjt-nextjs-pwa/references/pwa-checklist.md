...
- Rascunho offline mostra estado, persiste com seguranca e sincroniza idempotentemente. Finalize online nao espera a fila inteira.
- Oficina: pending no tap; action + push do hub na mesma transition.
- Passo do wizard: paint + URL no tap; rollback se o IndexedDB falhar.
