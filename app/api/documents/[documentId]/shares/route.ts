import { z } from "zod";
import { createDocumentShare, deliveryErrorResponse, shareCreateSchema } from "@/_pages/collection-documents/index.server";
import { jsonBody, noStoreJson } from "@/_pages/collection-lifecycle/index.server";

export const dynamic = "force-dynamic";

export async function POST(request: Request, context: RouteContext<"/api/documents/[documentId]/shares">) {
