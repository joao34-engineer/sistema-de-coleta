...
export async function GET(_request: Request, context: RouteContext<"/api/collections/[id]/draft">): Promise<Response> { const { id } = await context.params; return getDraft(id); }
