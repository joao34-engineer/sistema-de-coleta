...
| — | [Entrega parcial em reparo + leftovers](execution/workshop-partial-delivery-leftovers.md) | **Active** 2026-09-08. PR 1–4 e L1/L2/L3/L7 em código; L1+L2+L4+L6 **no remoto** (`07020000`/`07030000`/`07230000`/`07240000`); L5 pgTAP em código (ainda fora do CI); PR 5 aberto. Auditoria: [workshop-leftovers-audit-2026-09-07.md](design-patterns/workshop-leftovers-audit-2026-09-07.md) |
