...
| Plano de performance (informative) | [design-patterns/performance.md](design-patterns/performance.md) — Fases 1–7 feitas |
...
| Telas Figma (página 15) | [design-system/figma-prototype-frames.md](design-system/figma-prototype-frames.md) — 57 frames no app. Gaps vs Figma: [design-system/figma-page-15-gaps.md](design-system/figma-page-15-gaps.md). Histórico M01/M06: [figma-m01-m06-screens.md](design-system/figma-m01-m06-screens.md) |
...
| — | [Entrega parcial em reparo + leftovers](execution/workshop-partial-delivery-leftovers.md) | **Closed** 2026-09-12. SQL de produto **fechado** (remoto até `20260912120000`: PR 5 + L10). Actions de oficina em `collection-operations/api/actions.ts`. Residual adiado: pgTAP no CI (**não fazer**; Docker fora do projeto). Auditoria: [workshop-leftovers-audit-2026-09-07.md](design-patterns/workshop-leftovers-audit-2026-09-07.md) |
