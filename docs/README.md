...
| — | [Entrega parcial em reparo + leftovers](execution/workshop-partial-delivery-leftovers.md) | **Active** 2026-09-12. PR 1–4 e L1–L9 em código; L1+L2+L4+L6 **no remoto** até `20260907240000`; L5/L8/L9 **sem** schema novo (L5 ainda fora do CI). **D5** fechado 12/09/2026. PR 5 **no remoto** (`20260912100000`). Auditoria: [workshop-leftovers-audit-2026-09-07.md](design-patterns/workshop-leftovers-audit-2026-09-07.md) |
